...
CsLua.Collection.CsLuaDictionary = function(generics)
    local class = {
        __type = "CsLuaDictionary",
        __IsType = function(t) return t == "CsLuaDictionary"; end,
        __fullTypeName = "CsLua.Collection.CsLuaDictionary",
    }
    local getters = {};
    local publicClass = {};
    ...
    class.__Initialize = function(initTable)
        local i = 0;
