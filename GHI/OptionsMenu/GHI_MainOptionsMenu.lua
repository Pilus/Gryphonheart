...
function GHI_MainOptionsMenu()
		...
		onOk = function(self) end,
		{
			...
			},
			{
				...
				},
				{
					align = "r",
					type = "CheckBox",
					text = loc.HIDE_TARGET_BUTTON,
					label = "hide_target_button",
				},
			},
		},
	...
	menuFrame.refresh = function()
		...
		menuFrame.ForceLabel("hide_target_button", GHI_MiscData["hide_target_button"]);
	end;
	...
	menuFrame.okay = function()
		...
		GHI_MiscData["hide_target_button"] = menuFrame.GetLabel("hide_target_button") or false;
