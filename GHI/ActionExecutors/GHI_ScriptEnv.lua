...
function GHI_ScriptEnviroment(ownerGuid)
	...
	local environment = {
		...
		--Tmorph functions (from reverse engineering)
		GetDisplayID = GetDisplayID,
		SetDisplayID = SetDisplayID,
		GetMountDisplayID = GetMountDisplayID,
		SetMountDisplayID = SetMountDisplayID,
		GetVisibleItem = GetVisibleItem,
		SetVisibleItem = SetVisibleItem,
		GetVisibleEnchant = GetVisibleEnchant,
		SetVisibleEnchant = SetVisibleEnchant,
		GetRace = GetRace,
		GetAlternateRace = GetAlternateRace,
		SetAlternateRace = SetAlternateRace,
		GetGender = GetGender,
		SetGender = SetGender,
		...
		SetSpellVisual = SetSpellVisual,
		ApplySpellAura = ApplySpellAura,
		ClearSettings = ClearSettings,
		Morph = Morph,
		MorphRace = MorphRace,
		MorphMount = MorphMount,
		MorphItem = MorphItem,
