namespace GH
{
    ...
    [CsLuaAddOn("GH", "Gryphonheart AddOns", 70200, Author = "The Gryphonheart Team", Notes = "Core addon for the Gryphonheart AddOns suite.", Version = "3.0.1", SavedVariablesPerCharacter = new []{"GH_Settings", "GH_Buttons"})]
